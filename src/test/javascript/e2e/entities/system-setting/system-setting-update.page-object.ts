...
export default class SystemSettingUpdatePage {
  pageTitle: ElementFinder = element(by.id('somaliviswebappApp.systemSetting.home.createOrEditLabel'));
  ...
  enabledInput: ElementFinder = element(by.css('input#system-setting-enabled'));
