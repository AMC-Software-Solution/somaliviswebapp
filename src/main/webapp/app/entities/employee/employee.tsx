  ...
  return (
    <div>
      <h2 id="employee-heading">
        <Translate contentKey="somaliviswebappApp.employee.home.title">Employees</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="somaliviswebappApp.employee.home.createLabel">Create new Employee</Translate>
        </Link>
      </h2>
        ...
        {employeeList && employeeList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('profession')}>
                  <Translate contentKey="somaliviswebappApp.employee.profession">Profession</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('phone')}>
                  <Translate contentKey="somaliviswebappApp.employee.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('gender')}>
                  <Translate contentKey="somaliviswebappApp.employee.gender">Gender</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('bio')}>
                  <Translate contentKey="somaliviswebappApp.employee.bio">Bio</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('profilePhoto')}>
                  <Translate contentKey="somaliviswebappApp.employee.profilePhoto">Profile Photo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('enabled')}>
                  <Translate contentKey="somaliviswebappApp.employee.enabled">Enabled</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('reason')}>
                  <Translate contentKey="somaliviswebappApp.employee.reason">Reason</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('createdDate')}>
                  <Translate contentKey="somaliviswebappApp.employee.createdDate">Created Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="somaliviswebappApp.employee.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {employeeList.map((employee, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`somaliviswebappApp.Gender.${employee.gender}`} />
                  </td>
                  <td>{employee.bio}</td>
                  <td>
                    {employee.profilePhoto ? (
                      <div>
                        {employee.profilePhotoContentType ? (
                          <a onClick={openFile(employee.profilePhotoContentType, employee.profilePhoto)}>
                            <img
                              src={`data:${employee.profilePhotoContentType};base64,${employee.profilePhoto}`}
                        ...
                        <span>
                          {employee.profilePhotoContentType}, {byteSize(employee.profilePhoto)}
                        </span>
                      </div>
                    ) : null}
                  </td>
                  <td>{employee.profilePhotoUrl}</td>
                  <td>{employee.enabled ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="somaliviswebappApp.employee.home.notFound">No Employees found</Translate>
            </div>
          )
        )}
      </div>
