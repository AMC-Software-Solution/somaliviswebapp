...
export class EmployeeDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('somaliviswebappApp.employee.delete.question'));
...
export default class EmployeeComponentsPage {
  ...
  async deleteEmployee() {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/somaliviswebappApp.employee.delete.question/);
