...
export class CountryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('somaliviswebappApp.country.delete.question'));
...
export default class CountryComponentsPage {
  ...
  async deleteCountry() {
    ...
    expect(await countryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/somaliviswebappApp.country.delete.question/);
