  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="somaliviswebappApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="somaliviswebappApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('countryName')}>
                  <Translate contentKey="somaliviswebappApp.country.countryName">Country Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {countryList.map((country, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{country.countryFlagUrl}</td>
                  <td>{country.countryCallingCode}</td>
                  <td>{country.countryTelDigitLength}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="somaliviswebappApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
