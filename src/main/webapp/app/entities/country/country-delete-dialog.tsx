...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="somaliviswebappApp.country.delete.question">
        <Translate contentKey="somaliviswebappApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
