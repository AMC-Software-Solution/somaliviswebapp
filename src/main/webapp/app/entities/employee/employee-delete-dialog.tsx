...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="somaliviswebappApp.employee.delete.question">
        <Translate contentKey="somaliviswebappApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
